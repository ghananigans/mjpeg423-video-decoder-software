...
int initTimer (unsigned int milliseconds, void (*timerTickFunc)(void)) {
	...
	IOWR_ALTERA_AVALON_TIMER_PERIOD_0(TIMER_1_BASE, (timerPeriod & ALTERA_AVALON_TIMER_PERIOD_0_MSK));
	IOWR_ALTERA_AVALON_TIMER_PERIOD_1(TIMER_1_BASE, ((timerPeriod >> 16) & ALTERA_AVALON_TIMER_PERIOD_1_MSK));
	IOWR_ALTERA_AVALON_TIMER_PERIOD_2(TIMER_1_BASE, ((timerPeriod >> 32) & ALTERA_AVALON_TIMER_PERIOD_2_MSK));
	IOWR_ALTERA_AVALON_TIMER_PERIOD_3(TIMER_1_BASE, ((timerPeriod >> 48) & ALTERA_AVALON_TIMER_PERIOD_3_MSK));
